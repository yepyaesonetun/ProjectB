...
public abstract class BaseCursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
     ...
     */
    public BaseCursorRecyclerViewAdapter(Cursor cursor, String idColName) {
        mCursor = cursor;
        mIdColName = idColName;
        mRowIdColumn = cursor != null ? mCursor.getColumnIndex(mIdColName) : -1;
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (mCursor != null) {
            ...
            mRowIdColumn = newCursor.getColumnIndexOrThrow(mIdColName);
